<template>
  <div class="blockContainer">
    <div class="oneGroupAfterWash" v-for="(group,index) in itemGroups" :key="group.samples">
      <!--            项目-->
      <div class="column-stretch-flex--container groupSamples">
        <div class="line-flex-container">
          ...
          <el-select v-model="group.items" placeholder="" multiple
            ...
            <el-option v-for="item in afterWashItems" :key="item" :value="item"></el-option>
          </el-select>
      ...
      <div class="oneGroupAfterWashForm">
        <div class="line-flex-container">
          ...
          <div class="oneFormItem" style="flex: 1">
            ...
            <el-select  v-model="group.addForm.afterWashes"
                        class="thisMulSelect"
                        placeholder=""
                        style="flex: 1"
                        multiple>
            ...
            <el-button @click="addAfterWash(group)">+</el-button>
          </div>

        </div>
        <div class="afterWashTableContainer">
          <el-table :data="group.afterWashData" border class="removeTableGaps">
            ...
            <el-table-column :label="$t('afterWashes')">
              <template #default="scope">
                <el-select  v-model="scope.row.afterWashes"
                            placeholder=""
                            class="thisMulSelect"
                            multiple>
                  <el-option v-for="option in afterWashOptions" :key="option" :value="option">
            ...
            <el-table-column label="action" width="75">
              <template #default="scope">
                <el-button @click="removeAfterWash(group,scope.$index)" type="danger" style="margin: auto;display: block">
                  x</el-button>
              </template>
            </el-table-column>
          </el-table>
