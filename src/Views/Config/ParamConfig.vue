            ...
            <template #title>
              <div class="standardFamilyTitleContainer">
                ...
                <div class="operationContainer">
                  <el-button link @click.stop="atStandardFamilyCodeOpenParamAddDialog(standardFamily)">
                    <el-icon :size="22"><CirclePlus /></el-icon>
                  </el-button>
                </div>
              </div>
            </template>
            <el-table :data="standardFamily.paramList" border class="removeTableGaps">
              <el-table-column :label="$t('paramName')" prop="paramName" width="300">
              </el-table-column>
              <el-table-column :label="$t('allowedValue')" prop="allowedValue" >
              </el-table-column>
              ...
              <el-table-column :label="$t('operation')" width="124">
                <template #default="scope">
                  <el-button type="primary" :icon="Edit" @click="openParamEditDia(scope.row)"></el-button>
                  <el-popconfirm
                    class="box-item"
                  ...
                  >
                    <template #reference>
                      <el-button type="danger" :icon="Delete" style="margin-left: 5px" @click="delete(scope.row)"></el-button>
                    </template>
                  </el-popconfirm>
                </template>
              </el-table-column>
...
<!--        </el-table-column>-->
<!--        <el-table-column :label="$t('paramName')" prop="paramName">-->
<!--        </el-table-column>-->
<!--        <el-table-column :label="$t('operation')" width="124">-->
<!--          <template #default="scope">-->
...
<!--      </el-table>-->
    ...
    <el-dialog :title="$t(dialogTitle)" v-model="dialogVisible" width="60%">
      <div class="formContainer">
        ...
        <div style="margin-top: 10px;border-top: 1px dashed goldenrod">
          ...
          <el-form label-width="auto">
            ...
            <el-form-item :label="$t('test')">
              <el-table :data="testTableData" class="removeTableGaps" border>
                <el-table-column v-for="(param,index) in getParams(dialogForm.formula)" :key="param" :label="param">
                </el-table-column>
                <el-table-column :label="$t('result')">
                  <template #default="scope">
      ...
      <template #footer>
        <el-button @click="test">{{$t("test")}}</el-button>
...
//在标准族下添加参数
function atStandardFamilyCodeOpenParamAddDialog(){
  dialogVisible.value=true
  dialogTitle.value='add'
}
// function openParamAddDia(){
//   dialogVisible.value=true
//   dialogTitle.value='add'
// }
function openParamEditDia(row){
  dialogVisible.value=true
