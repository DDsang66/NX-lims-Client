        ...
        <template #default="props">
          <div style="margin-left: 50px;">
            <el-table :data="props.row.lines" style="width: 100%" ref="innerTableRef" border>
              <el-table-column label="Group" prop="testGroup" :formatter="funcs.emptyDisplay" />
              ...
              <el-table-column prop="sampleCount" label="No. of Sample" :formatter="funcs.emptyDisplay" />-->
...
<template>
  ...
  display: flex;flex-direction: column;align-items: center;gap: 20px;width: 100%;height: 100%">
        ...
        <template #default="props">
          <div style="margin-left: 50px;">
            <el-table :data="props.row.lines" style="width: 100%" ref="innerTableRef" border>
              ...
              <!-- [新增] 内部表格 WorkSheet Url 列 -->
              <el-table-column label="WorkSheet Url" width="150">
                <template #default="scope">
                  <el-link 
                    v-if="scope.row.workSheetUrl" 
                    type="primary" 
                    :href="scope.row.workSheetUrl" 
                    target="_blank"
                    :underline="false">
                    Open Worksheet
                  </el-link>
    ...
    <el-table class="removeTableGaps"
      ...
      <!-- [新增] 外部表格 WorkSheet Url 列 -->
      <el-table-column width="150" label="WorkSheet Url">
        <template #default="scope">
          <el-link 
            v-if="scope.row.workSheetUrl" 
            type="primary" 
